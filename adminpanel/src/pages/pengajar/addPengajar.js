...
function AddPengajar() {
  ...
  const [Bidang, setTags] = useState([]);
  const handleChangeTags = (Bidang) => {
    setTags(Bidang);
  };
  ...
  useEffect(() => {
    setFormData((formData) => ({
      ...formData,
      Bidang: Bidang.join(", "), // or however you want to format it
    }));
  }, [Bidang]);
  ...
  const handleSubmit = async (e) => {
    ...
    data.append("Urlphoto", fileField.files[0]);
                ...
                <div className="card">
                  <div className="card-body">
                    ...
                    <p className="card-title-desc">
                      This form is used to update the details of a pengajar in
                    ...
                    >
                      ...
                      <div className="row">
                        <div className="col-md-6">
                          <div className="mb-3">
                            <label htmlFor="Bidang" className="form-label">
                              Bidang
                            </label>
                            <TagsInput
                              value={Bidang}
