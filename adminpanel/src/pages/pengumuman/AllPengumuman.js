...
function AllPengumuman() {
                ...
                fetch(`${BASE_URL}api/pengumuman/${id}`, {
                    ...
                    .then(response => {
                        if (response.ok) {
                            ...
                            setPengumuman(pengumumans.filter(pengumuman => pengumuman.id !== id));
                            swal.fire(
                                'Deleted!',
    ...
    const paginatedData = filteredPengumumans.slice(currentPage * perPage, (currentPage + 1) * perPage);
                                ...
                                <div className="card">
                                    <div className="card-body">
                                        ...
                                        <p className="card-title-desc" >
                                            This page displays all announcements in a searchable and paginated table. The data is fetched from an external API and updates dynamically.
                                        </p>
                                            ...
                                            <div className="row">
                                                ...
                                                <div className="col-sm-12 col-md-6">
                                                    <div id="datatable-buttons_filter" className="dataTables_filter">
                                                        <label>Search:
                                                            <input type="search" className="form-control form-control-sm" placeholder="" aria-controls="datatable-buttons" onChange={handleSearchChange} /></label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="row">
                                            <div className="col-sm-12 col-md-5">
                                                <div className="dataTables_info" id="datatable-buttons_info" role="status" aria-live="polite">Showing {currentPage * perPage + 1} to {Math.min((currentPage + 1) * perPage, pengumumans.length)} of {pengumumans.length} entries</div>
                                            </div>
