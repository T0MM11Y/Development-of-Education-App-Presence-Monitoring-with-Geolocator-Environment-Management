...
function TanyaJawab() {
    ...
    if (filterHari) {
      ...
      switch (filterHari) {
        case "Hari Ini":
          data = data.filter(
            (item) =>
              new Date(item.tanggal_tanya).toDateString() ===
              today.toDateString()
          );
          break;
        case "Semalam":
        ...
        case "Bulan Ini":
          data = data.filter(
            (item) =>
              new Date(item.tanggal_tanya).getMonth() === today.getMonth()
          );
          break;
        case "Tahun Ini":
          data = data.filter(
            (item) =>
              new Date(item.tanggal_tanya).getFullYear() === today.getFullYear()
          );
          break;
        default:
          break;
    ...
    data = data.filter(
      (item) =>
        (item.pertanyaan
          ...
          : false) ||
        (item.user && item.user.Nama_Depan
          ? item.user.Nama_Depan.toLowerCase().includes(
              searchTerm.toLowerCase()
            )
          : false) ||
        (item.user && item.user.Nama_Belakang
          ? item.user.Nama_Belakang.toLowerCase().includes(
              searchTerm.toLowerCase()
            )
          : false)
    );
  ...
  const handleSubmit = async (event) => {
    ...
    const response = await fetch(
      `${BASE_URL}api/tanyajawab/${currentQuestionId}`,
      {
        method: "PUT",
        headers: {
                ...
                <div className="card">
                  <div className="btn-toolbar p-3" role="toolbar">
                    ...
                    <div class="btn-group me-2 mb-2 mb-sm-0">
                      ...
                      <div class="dropdown-menu">
                        <a
                          class="dropdown-item"
                          href="#"
                          onClick={() => handleFilterHariChange("")}
                        >
                          Semua
                        </a>
                        <a
                          class="dropdown-item"
                          href="#"
                          onClick={() => handleFilterHariChange("Hari Ini")}
                        >
                          Hari Ini
                        </a>
                        <a
                          class="dropdown-item"
                          href="#"
                          onClick={() => handleFilterHariChange("Semalam")}
                        >
                          Semalam
                        </a>
                        <a
                          class="dropdown-item"
                          href="#"
                          onClick={() => handleFilterHariChange("Bulan Ini")}
                        >
                          Bulan Ini
                        </a>
                        <a
                          class="dropdown-item"
                          href="#"
                          onClick={() => handleFilterHariChange("Tahun Ini")}
                        >
                          Tahun Ini
                        </a>
                      </div>
                    ...
                    <div class="btn-group me-2 mb-2 mb-sm-0">
                      ...
                      <div class="dropdown-menu">
                        <a
                          class="dropdown-item"
                          href="#"
                          onClick={() => handleFilterResponsChange("")}
                        >
                          Semua
                        </a>
                        <a
                          ...
                          href="#"
                          onClick={() =>
                            handleFilterResponsChange("Belum Dijawab")
                          }
                        >
                          Belum Dijawab
                        </a>
                        <a
                          ...
                          href="#"
                          onClick={() =>
                            handleFilterResponsChange("Sudah Dijawab")
                          }
                        >
                          Sudah Dijawab
                        </a>
                    ...
                    <table
                      ...
                      className="table table-striped table-bordered dt-responsive dataTable no-footer dtr-inline"
                    >
                      <thead>
                        <tr>
                          <th>#</th>
                        ...
                        {questions.length > 0 ? (
                          currentData.map((question, index) => (
                            ...
                            >
                              ...
                              <td>
                                {timeSince(new Date(question.tanggal_tanya))}
                              </td>
                              <td>
                                <div
                                  style={{
                                    ...
                                    onClick={() => {
                                      Swal.fire({
                                        ...
                                        if (result.isConfirmed) {
                                          fetch(
                                            `${BASE_URL}api/tanyajawab/${question.id}`,
                                            {
                                              method: "DELETE",
                                            }
                                          ).then(() => {
