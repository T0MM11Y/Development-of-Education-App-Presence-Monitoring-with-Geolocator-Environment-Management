    ...
    return WillPopScope(
      ...
      child: Scaffold(
        appBar: PreferredSize(
          ...
          child: Padding(
            padding: const EdgeInsets.only(
                top: 5.0, left: 10.0, right: 30.0, bottom: 1.0),
            child: AppBar(
              actions: [
                IconButton(
                                ...
                                child: Container(
                                  ...
                                  child: Image(
                                    image: controller.imageUrl.value.isNotEmpty
                                        ...
                                        : AssetImage(
                                            'assets/images/default_profile.png'), // replace with your default image
                                    fit: BoxFit.contain,
                                  ),
                                ),
                              );
                      ...
                      Positioned(
                        ...
                        child: IconButton(
                          icon: Icon(
                            Icons.camera_alt,
                            color: Colors
                                .blue, // Change the color of the icon here
                          ),
                          onPressed: () async {
                    ...
                    children: [
                      ...
                      Expanded(
                        child: TextFormField(
                          ...
                          style: TextStyle(
                              fontSize: 21, fontFamily: 'incosolata '),
        ...
        bottomNavigationBar: CustomBottomNavigationBar(
          initialActiveIndex:
              2, // Set the initial active index to 2 for Profile
          onTap: (int i) async {
            switch (i) {
              case 0: // Home
